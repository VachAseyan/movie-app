...
const PopularMovieCard = ({ movie, onMovieClick }) => {
    ...
    return (
        <div onClick={() => onMovieClick(movie.id)} style={{ cursor: "pointer", position: "relative", overflow: 'visible' }}>
            <Card
                hoverable
                style={{ overflow: 'visible' }} // VERY IMPORTANT
                cover={
                    <div style={{ position: "relative" }}>
                        ...
                        />
                        {/* Badge in bottom-left, half inside, half outside */}
                        <div style={{
                            position: 'absolute',
                            bottom: '-15px',
                            left: '12px',
